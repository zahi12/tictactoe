...
if __name__ == "__main__": 
    ...
    print(board.get_case(grid_position=(2,3), case_position=(1,3)).owner)
    ...
    if player.win_grid(grid_position = (2,3)) :                                  #la victoire de great grid
