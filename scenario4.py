...
if __name__ == "__main__": 
    ...
    if player.win_grid(grid_position = (2,1)) :                                  #la victoire de grid
        raise Exception("on est pas censé avoir gagné la grille")
    if player.win_game() :                                             #la victoire totale
        raise Exception("on est pas censé avoir gagné la partie")        
    ...
    if player.win_grid(grid_position = (3,3)) :                                  #la victoire de grid
        raise Exception("on est pas censé avoir gagné la grille")
    if player.win_game() :                                             #la victoire totale
        raise Exception("on est pas censé avoir gagné la partie")        
    ...
    if player.win_grid(grid_position = (3,2)) :                                  #la victoire de grid
        raise Exception("on est pas censé avoir gagné la grille")
    if player.win_game() :                                             #la victoire totale
        raise Exception("on est pas censé avoir gagné la partie")        
    ...
    if player.win_grid(grid_position = (2,2)) :                                  #la victoire de grid
        raise Exception("on est pas censé avoir gagné la grille")
    if player.win_game() :                                             #la victoire totale
        raise Exception("on est pas censé avoir gagné la partie")        
    ...
    if not player.win_grid(grid_position = (3,3)) :                                  #la victoire de grid
        raise Exception("on est censé avoir gagné la grille")
    if player.win_game() :                                             #la victoire totale
        raise Exception("on est pas censé avoir gagné la partie")        
    if player.draw_grid(grid_position = (3,3)) : 
    ...
    if player.win_grid(grid_position = (1,2)) :                                  #la victoire de grid
        raise Exception("on est pas censé avoir gagné la grille")
    if player.win_game() :                                             #la victoire totale
        raise Exception("on est pas censé avoir gagné la partie")        
    ...
    if player.win_grid(grid_position = (3,1)) :                                  #la victoire de grid
        raise Exception("on est pas censé avoir gagné la grille")
    if player.win_game() :                                             #la victoire totale
        raise Exception("on est pas censé avoir gagné la partie")        
    ...
    if not player.win_grid(grid_position = (2,2)) :                                  #la victoire de grid
        raise Exception("on est  censé avoir gagné la grille")
    if not player.win_game() :                                             #la victoire totale
        raise Exception("on est pas censé avoir gagné la partie")        
    if player.draw_grid(grid_position = (2,2)) : 
        raise Exception("on est pas censé avoir égalité dans la grille")                         #l'égalité sur great grid      
    if player.draw_game() :                                              #égalité totale
