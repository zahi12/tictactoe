# -*- coding: utf-8 -*-
"""
Created on Sat Apr 13 15:15:15 2019
...
class Player() : 
    ...
    def play(self, grid_position, case_position):
        ...
        if self.draw_grid(grid_position):
            ...
            grid.owner = 0                         
        if self.win_grid(grid_position,player): 
            grid=self.board.get_grid(grid_position)
    ...
    def win_line(self,grid_position, player):
        for i in range (1,4):
            count = 0
            for j in range (1,4):
    ...
    def win_column(self,grid_position, player):
        for j in range (1,4):
            count=0
            for i in range (1,4):
                case = self.board.get_case(grid_position, (i,j))
    ...
    def win_diagonal(self,grid_position, player):
        count1=0
        count2=0
    ...
    def win_grid(self,grid_position, player):
        if self.win_line(grid_position, player) or self.win_column(grid_position, player) or self.win_diagonal(grid_position, player):
            return True
        else:
            return False
    ...
    def draw_grid(self,grid_position):
        ...
        if grid.grid_is_full() and (grid.owner==0 or grid.owner==None) :
            return True
        return False
   
    def win_COLUMN(self,player):
        for j in range (1,4):
            count=0
            count_draw=0
            for i in range (1,4):
    ...
    def win_game(self,player):
        if self.win_LINE(player) or self.win_COLUMN(player) or self.win_DIAGONAL(player):
            return True
        else:
            return False
