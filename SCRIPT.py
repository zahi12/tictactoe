...
#comment se repérer et parcourir self.grids et self.cases à partir de la position d'une case/grille ? ce ne sont pas des entiers mais des objets
#get current player ne retourne pas un joueur
